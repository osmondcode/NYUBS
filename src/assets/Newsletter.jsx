...
const Newsletter = () => {
  ...
  return (
    <section className="w-full min-h-[70vh] lg:px-[8%] px-[5%] my-[80px] flex flex-col items-center justify-start">
      <h1 className="raleway font-medium text-[20px] text-[var(--dgreen)] mb-[25px]">
        RECENT NEWS
      </h1>

      <div className="w-[90%] h-fit flex items-center justify-around gap-5 flex-wrap">
        <span className="w-[280px] h-[380px] bg-[var(--llgreen)] rounded-md p-2 overflow-hidden relative flex flex-col justify-between">
          <div className="w-full h-fit mt-[20px] flex flex-col items-center justify-center overflow-hidden">
            <img
              src={array1[currentIndex].img}
              alt="News image"
              className="w-full h-[150px] object-cover brightness-90 hover:scale-[1.05] duration-500 cursor-pointer"
            />
          ...
          <div className="w-full h-fit  flex mt-[30px] mb-[10px] items-end justify-end">
            <button className="w-fit h-fit px-2 py-1 text-[12px] rounded-[2px] bg-[var(--lgreen)] raleway font-medium text-[var(--bg)] hover:bg-transparent border-[0.5px] border-[var(--lgreen)] hover:border-[var(--dgreen)] hover:text-[var(--dgreen)] duration-300">
              Read More
            </button>
          </div>
        </span>
